...
5. Create a new `.thoughts/iteration-NN/implementation-NN.md` file at the next version number
...
- `.thoughts/iteration-NN/implementation-NN.md` created in current iteration

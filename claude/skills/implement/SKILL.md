...
2. Read these thoughts:
    - The most recent plan file (highest NN) matching `.thoughts/iteration-NN/plan/plan-*.md`
...
5. Create a new `.thoughts/iteration-NN/implementation/implementation-NN-topic.md` file at the next version number (include a short kebab-case topic in the filename)
6. Append a one-line entry to `.thoughts/iteration-NN/log.md` describing what was implemented and linking to the artifact
...
- `.thoughts/iteration-NN/implementation/implementation-NN-topic.md` created in current iteration

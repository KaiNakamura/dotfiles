...
5. Create a new `.thoughts/iteration-NN/understanding/understanding-NN.md` file at the next number (e.g., if the most recent file is `understanding-01.md`, write to `understanding-02.md`)

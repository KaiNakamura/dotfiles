...
2. Read these thoughts, follow @read-only-specified-thoughts:
    - `.thoughts/iteration-NN/plan-NN.md`: The most recent (highest number) plan
...
5. Create a new `.thoughts/iteration-NN/implementation/implementation-NN.md` file at the next number (e.g., if the most recent file is `implementation-01.md`, write to `implementation-02.md`)
</TASK>
